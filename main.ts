...
function pickALevel () {
    levelPicker = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Player)
    l1icon = sprites.create(assets.image`2a`, SpriteKind.Food)
    controller.moveSprite(levelPicker)
    levelPicker.setPosition(73, 48)
    tiles.setTilemap(tilemap`levelPicker`)
    tiles.placeOnRandomTile(l1icon, assets.tile`myTile2`)
    if (levelPicker.overlapsWith(l1icon)) {
        level1()
    }
}
...
let l1icon: Sprite = null
let levelPicker: Sprite = null
